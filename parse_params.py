...
def flatten_netlist(file: str, flat_file: str):
    ...
    Args:
        file: path to a file
        flat_file : path to a file storing the flattened netlist
    ...
    write_flat_file(subckts, commands, flat_file, params)
    return subckts, params, order, commands

def write_flat_file(subckts: dict, commands: list, flat_file: str, params: dict):
